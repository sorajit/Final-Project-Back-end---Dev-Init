...
## การวิธีการใช้งาน
ผู้ใช้งานจะต้องทำการลงทะเบียนผ่าน /auth/register โดย username และ email จะต้องไม่ซ้ำกับผู้ใช้งานอื่นๆ เมื่อลงทะเบียนหรือทำการเข้าสู่ระบบสำเร็จ จะได้รับ token เพื่อใช้สำหรับการยืนยันสิทธ์ในการดำเนินการต่างๆ ทั้งการเรียกดู สร้าง แก้ไข และลบ ข้อมูลต่างๆ ใน Daily Log, To-do List และ Calendar Events
